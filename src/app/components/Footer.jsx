            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li><Link href="/services" className="text-gray-600 hover:text-primary">Engine Repair</Link></li>
                        <li><Link href="/services" className="text-gray-600 hover:text-primary">Brake Service</Link></li>
                        <li><Link href="/services" className="text-gray-600 hover:text-primary">Oil Change</Link></li>
                        <li><Link href="/services" className="text-gray-600 hover:text-primary">Tire Rotation</Link></li>
                        <li><Link href="/services" className="text-gray-600 hover:text-primary">Diagnostics</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><Link href="/blogs" className="text-gray-600 hover:text-primary">Our Blog</Link></li>
